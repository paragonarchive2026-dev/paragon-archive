...
(() => {
  const definitions = [
    ...
    { name: "Paragon Chess", group: "Games", category: "Games", inside: "Full-rule computer chess in a refined tournament room", features: ["Free play as White against a local computer", "Casual, Club and Master strengths", "Complete castling, en passant and promotion rules", "Checkmate, stalemate, repetition, 50-move and material draws", "Position hints and signed move ledger", "Save and resume on this device", "Game-specific performance leaderboard"], icon: "♟", tag: "Chess", siteUrl: "games/chess/index.html", version: "v1.0 — Sep 6, 2026", live: true, buildProgress: 90, previewOnly: false },
    { name: "Paragon Cards", group: "Games", category: "Games", inside: "Card games — Higher·Lower, Blackjack 21, Solitaire and Memory Match are live", features: ["Higher·Lower duel against the house", "Blackjack 21 against the dealer", "Solitaire + Memory Match cabinets", "Seeded, replayable deck", "Save and resume mid-game", "Local personal bests", "Free forever — no coins move in free play"], icon: "🃏", tag: "Card Games", siteUrl: "games/cards/index.html", version: "v1.0 — Sep 6, 2026", live: true, buildProgress: 90, previewOnly: false },
    ...
    { name: "Paragon Arcade", group: "Games", category: "Games", inside: "Five quick skill cabinets — Reflex Tap, Memory Match, Timing Bar, Sequence Repeat and Target Sprint", features: ["Reflex Tap reaction rounds", "Memory Match pairs + combo", "Timing Bar bullseye stops", "Sequence Repeat patterns", "Target Sprint 25-second aim", "Seeded, replayable rounds", "Save and resume on this device", "Game-specific performance leaderboard"], icon: "🕹️", tag: "Arcade", siteUrl: "games/arcade/index.html", version: "v1.0 — Sep 11, 2026", live: true, buildProgress: 90, previewOnly: false },
    ...
    { name: "Paragon Spin", group: "Games", category: "Games", inside: "Precision wheel duel against the house", features: ["Twelve-sector physical-style wheel", "Six-turn player-versus-house duel", "One shared seeded result", "Published equal-odds scoring", "Save and resume on this device", "Free for guests and zero-balance members", "Game-specific performance leaderboard"], icon: "◉", tag: "Precision Wheel", siteUrl: "games/spin/index.html", version: "v1.0 — Sep 6, 2026", live: true, buildProgress: 90, previewOnly: false },
    ...
    { name: "Paragon Invoice", group: "Finance & Business", category: "Finance", inside: "Invoice generator", features: ["Line items", "Tax/discount", "Multi-currency", "Print/PDF/DOCX/JSON", "Payment terms"], icon: "🧾", tag: "Invoices", siteUrl: "sites/invoice-generator/index.html", version: "v1.2 — Sep 3, 2026", live: true, buildProgress: 95, previewOnly: false },
    ...
    { name: "Paragon Shop", group: "Finance & Business", category: "Finance", inside: "Shopping shortlists", features: ["Shortlists", "Dual-store price compare", "Budget cap", "CSV export", "No checkout (honest)"], icon: "🛍️", tag: "Shopper", siteUrl: "sites/personal-shopper/index.html", version: "v1.1 — Sep 3, 2026", live: true, buildProgress: 90, previewOnly: false },
    ...
    { name: "Paragon Recipe", group: "Lifestyle & Health", category: "Lifestyle", inside: "Recipe and cooking", features: ["Cookbook", "Scale", "Subs/ratios", "Local nutrition estimate", "Cook timer"], icon: "🍳", tag: "Cooking", siteUrl: "sites/recipe-creator/index.html", version: "v1.2 — Sep 3, 2026", live: true, buildProgress: 94, previewOnly: false },
    ...
    { name: "Paragon Travel", group: "Lifestyle & Health", category: "Lifestyle", inside: "Trip planner", features: ["Pacing-aware day drafts", "Budget parts", "Entry checklists", "Packing", "Print/export"], icon: "✈️", tag: "Travel", siteUrl: "sites/travel-assistant/index.html", version: "v1.2 — Sep 3, 2026", live: true, buildProgress: 95, previewOnly: false },
