...
(() => {
  const definitions = [
    ...
    { name: "Paragon Invoice", group: "Finance & Business", category: "Finance", inside: "Invoice generator", features: ["Line items", "Tax/discount", "Multi-currency", "Print/PDF/DOCX/JSON", "Payment terms"], icon: "🧾", tag: "Invoices", siteUrl: "sites/invoice-generator/index.html", version: "v1.2 — Sep 3, 2026", live: true, buildProgress: 92, previewOnly: false },
    ...
    { name: "Paragon Shop", group: "Finance & Business", category: "Finance", inside: "Shopping shortlists", features: ["Shortlists", "Dual-store price compare", "Budget cap", "CSV export", "No checkout (honest)"], icon: "🛍️", tag: "Shopper", siteUrl: "sites/personal-shopper/index.html", version: "v1.1 — Sep 3, 2026", live: true, buildProgress: 85, previewOnly: false },
    ...
    { name: "Paragon Recipe", group: "Lifestyle & Health", category: "Lifestyle", inside: "Recipe and cooking", features: ["Cookbook", "Scale", "Subs/ratios", "Local nutrition estimate", "Cook timer"], icon: "🍳", tag: "Cooking", siteUrl: "sites/recipe-creator/index.html", version: "v1.2 — Sep 3, 2026", live: true, buildProgress: 90, previewOnly: false },
    ...
    { name: "Paragon Travel", group: "Lifestyle & Health", category: "Lifestyle", inside: "Trip planner", features: ["Pacing-aware day drafts", "Budget parts", "Entry checklists", "Packing", "Print/export"], icon: "✈️", tag: "Travel", siteUrl: "sites/travel-assistant/index.html", version: "v1.2 — Sep 3, 2026", live: true, buildProgress: 88, previewOnly: false },
