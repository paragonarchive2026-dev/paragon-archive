...
(() => {
  const definitions = [
    ...
    { name: "Paragon Invoice", group: "Finance & Business", category: "Finance", inside: "Invoice generator", features: ["Create invoices", "Add items", "Calculate totals", "Export PDF", "Track payments"], icon: "🧾", tag: "Invoices" },
    ...
    { name: "Paragon Shop", group: "Finance & Business", category: "Finance", inside: "E-commerce builder", features: ["Product listings", "Cart", "Checkout flow", "Store template"], icon: "🛍️", tag: "E-commerce" },
    ...
    { name: "Paragon Recipe", group: "Lifestyle & Health", category: "Lifestyle", inside: "Recipe and cooking", features: ["Recipe search", "Meal planner", "Shopping list", "Cook mode timer"], icon: "🍳", tag: "Cooking" },
    ...
    { name: "Paragon Travel", group: "Lifestyle & Health", category: "Lifestyle", inside: "Trip planner", features: ["Itinerary builder", "Packing lists", "Budget tracker", "Destination information"], icon: "✈️", tag: "Travel" },
