...
(() => {
  const definitions = [
    ...
    { name: "Paragon Files", group: "Productivity & Tools", category: "Tools", inside: "All file operations", features: ["Image convert/resize/batch ZIP", "CSV↔JSON↔TSV", "MD/HTML helpers", "ZIP pack", "Honest codec guide"], icon: "📁", tag: "Files", siteUrl: "sites/file-converter/index.html", version: "v1.2 — Sep 3, 2026", live: true, buildProgress: 88, previewOnly: false },
    ...
    { name: "Paragon Resume", group: "Productivity & Tools", category: "Productivity", inside: "Resume and CV builder", features: ["Templates", "LinkedIn paste import", "Job-post keyword tailor", "DOCX + Print/PDF", "Cover letter"], icon: "📄", tag: "Career", siteUrl: "sites/resume-maker/index.html", version: "v1.2 — Sep 3, 2026", live: true, buildProgress: 90, previewOnly: false },
    ...
    { name: "Paragon Photo", group: "Creative & Design", category: "Creative", inside: "Photo editing suite", features: ["Filters", "Crop", "Brightness/contrast/sat", "Text overlay", "Rotate/flip", "JPG/PNG/WebP export"], icon: "📷", tag: "Photo Editing", siteUrl: "sites/photo-editor/index.html", version: "v1.2 — Sep 3, 2026", live: true, buildProgress: 88, previewOnly: false },
    ...
    { name: "Paragon Flash", group: "Education & Learning", category: "Education", inside: "Flashcard study tool", features: ["Cloze + reverse cards", "SM-2 scheduling", "Anki TSV/JSON export", "Due-first study"], icon: "🃏", tag: "Flashcards", siteUrl: "sites/flashcard-generator/index.html", version: "v1.2 — Sep 3, 2026", live: true, buildProgress: 92, previewOnly: false },
