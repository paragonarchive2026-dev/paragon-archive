...
(() => {
  const definitions = [
    ...
    { name: "Paragon Files", group: "Productivity & Tools", category: "Tools", inside: "All file operations", features: ["PDF viewer and merger", "Image/document/video/audio converter", "File compressor", "Batch processing"], icon: "📁", tag: "Files", siteUrl: "sites/file-converter/index.html", version: "v1.0 — Sep 3, 2026", live: true, buildProgress: 70, previewOnly: false },
    ...
    { name: "Paragon Resume", group: "Productivity & Tools", category: "Productivity", inside: "Resume and CV builder", features: ["Templates", "Flexible sections", "Export to PDF", "Live preview", "Cover letter builder"], icon: "📄", tag: "Career", siteUrl: "sites/resume-maker/index.html", version: "v1.0 — Sep 3, 2026", live: true, buildProgress: 75, previewOnly: false },
    ...
    { name: "Paragon Photo", group: "Creative & Design", category: "Creative", inside: "Photo editing suite", features: ["Filters", "Crop and resize", "Adjustments", "Text overlay", "Avatar/profile picture creator", "Collage maker"], icon: "📷", tag: "Photo Editing", siteUrl: "sites/photo-editor/index.html", version: "v1.0 — Sep 3, 2026", live: true, buildProgress: 65, previewOnly: false },
    ...
    { name: "Paragon Flash", group: "Education & Learning", category: "Education", inside: "Flashcard study tool", features: ["Create decks", "Spaced repetition", "Flip cards", "Study statistics"], icon: "🃏", tag: "Flashcards", siteUrl: "sites/flashcard-generator/index.html", version: "v1.0 — Sep 3, 2026", live: true, buildProgress: 80, previewOnly: false },
  ...
  definitions.forEach((definition, index) => {
    ...
    if (existing) {
      Object.assign(existing, {
        ...
        ...(definition.previewOnly === false ? { previewOnly: false } : {})
      });
      return;
    }
    sequence += 1;
