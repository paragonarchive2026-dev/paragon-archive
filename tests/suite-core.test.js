...
assert(serviceWorker.includes('"./paragon-archive-hub.html"') && serviceWorker.includes('"./archive-hub.js"') && serviceWorker.includes("paragon-archive-v77"), "Hub is missing from the current PWA shell");
